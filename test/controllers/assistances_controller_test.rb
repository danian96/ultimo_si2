...
class AssistancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assistance" do
    assert_difference('Assistance.count') do
      post assistances_url, params: { assistance: { date_of_assistance: @assistance.date_of_assistance, day: @assistance.day, final_time: @assistance.final_time, init_time: @assistance.init_time, people_id: @assistance.people_id } }
    end
  ...
  test "should update assistance" do
    patch assistance_url(@assistance), params: { assistance: { date_of_assistance: @assistance.date_of_assistance, day: @assistance.day, final_time: @assistance.final_time, init_time: @assistance.init_time, people_id: @assistance.people_id } }
