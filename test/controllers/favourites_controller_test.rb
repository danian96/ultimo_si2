...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post favourites_url, params: { favourite: { actionlink: @favourite.actionlink, name: @favourite.name, user_id: @favourite.user_id } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { actionlink: @favourite.actionlink, name: @favourite.name, user_id: @favourite.user_id } }
