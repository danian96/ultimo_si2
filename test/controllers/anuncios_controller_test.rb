...
class AnunciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anuncio" do
    assert_difference('Anuncio.count') do
      post anuncios_url, params: { anuncio: { departamento_id: @anuncio.departamento_id, descripcion: @anuncio.descripcion, estado: @anuncio.estado, titulo: @anuncio.titulo } }
    end
  ...
  test "should update anuncio" do
    patch anuncio_url(@anuncio), params: { anuncio: { departamento_id: @anuncio.departamento_id, descripcion: @anuncio.descripcion, estado: @anuncio.estado, titulo: @anuncio.titulo } }
